...
let CandidateSearchPageModule = class CandidateSearchPageModule {
};
CandidateSearchPageModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            FormsModule,
...
], CandidateSearchPageModule);
export { CandidateSearchPageModule };
//# sourceMappingURL=candidate-search.module.js.map