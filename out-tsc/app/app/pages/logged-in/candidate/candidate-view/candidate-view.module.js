...
let CandidateViewPageModule = class CandidateViewPageModule {
};
CandidateViewPageModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
            FormsModule,
...
export { CandidateViewPageModule };
//# sourceMappingURL=candidate-view.module.js.map