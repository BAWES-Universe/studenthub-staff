...
let ExperienceFormPage = class ExperienceFormPage {
    constructor(alertCtrl, toastCtrl, modalCtrl) {
        ...
        this.txtExperience = '';
        this.loading = false;
        this.tmpExperience = []; // assignment initial value
        this.dirty = false;
        this.count = 1;
        this.maxExperiencesAllowed = 40;
    }
    ngOnInit() {
    ...
    ionViewDidEnter() {
        ...
        setTimeout(() => {
            ...
            const lastElement = document.getElementById('input[' + lastElementIndex + ']');
            if (lastElement) {
...
export { ExperienceFormPage };
//# sourceMappingURL=experience-form.page.js.map