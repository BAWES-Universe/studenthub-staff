...
let CandidateFilterPage = class CandidateFilterPage {
    constructor(httpClient, transferState, router, platform, location, navCtrl, popoverCtrl, auth, algoliaService, candidateService, 
...
], CandidateFilterPage.prototype, "content", void 0);
__decorate([
    ViewChild('instantSearch', { static: false })
], CandidateFilterPage.prototype, "instantSearch", void 0);
CandidateFilterPage = __decorate([
    Component({
...
export { CandidateFilterPage };
//# sourceMappingURL=candidate-filter.page.js.map