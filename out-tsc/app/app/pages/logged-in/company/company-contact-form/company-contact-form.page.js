...
let CompanyContactFormPage = class CompanyContactFormPage {
    constructor(companyContactService, _fb, modalCtrl, _alertCtrl) {
    ...
    get emails() { return this.f.emails; }
    get phones() { return this.f.phones; }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            action.subscribe((jsonResponse) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (jsonResponse.operation == "error") {
                    let prompt = yield this._alertCtrl.create({
...
CompanyContactFormPage = __decorate([
    Component({
        selector: 'app-company-contact-form',
        templateUrl: './company-contact-form.page.html',
        styleUrls: ['./company-contact-form.page.scss'],
    })
], CompanyContactFormPage);
export { CompanyContactFormPage };
//# sourceMappingURL=company-contact-form.page.js.map