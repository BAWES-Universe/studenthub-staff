...
export const genericRetryStrategy = ({ maxRetryAttempts = 3, scalingDuration = 1000, excludedStatusCodes = [400, 401, 404, 500] } = {}) => (attempts) => {
...
//# sourceMappingURL=genericRetryStrategy.js.map