...
let SentryErrorhandlerService = class SentryErrorhandlerService extends ErrorHandler {
    constructor() {
        super();
        // Should we log to sentry or not?
        this.sentryLoggingEnabled = false;
        // Array of environments to log
        this.environmentsLogged = ["dev", "prod", "dev-mobile", "prod-mobile"];
...
SentryErrorhandlerService = __decorate([
    Injectable({
        providedIn: 'root'
    })
], SentryErrorhandlerService);
export { SentryErrorhandlerService };
//# sourceMappingURL=sentry.errorhandler.service.js.map