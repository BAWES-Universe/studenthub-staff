...
export class CompanyContactService {
   ...
   * @param companyID
   */
  companyContacts(companyID, query = '', expands= 'contact.contactEmails,contact.contactPhones,company,contact.notes,contact.requests,contact.companyContactStats'): Observable<any>{
